            ...
            >
                <PopoverTrigger asChild>
                    <Button
                        ...
                        className={cn(
                            "flex w-full shadow-none p-1 rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
                            className
                        )}
                    >
                        {selectedValues.length > 0 ? (
                            <div className="flex justify-between items-center w-full">
                                <div className="flex flex-nowrap gap-1 items-center truncate text-ellipsis">
