            ...
            <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8">
                        <Logo />
                        <p className="text-sm/6 text-balance opacity-60">
                            Making the world a better place through constructing elegant hierarchies.
                        </p>
                        <div className="flex gap-x-6">
                            {navigation.social.map((item) => (
                                <a key={item.name} href={item.href} className="opacity-60 hover:opacity-60">
                            ...
                            <div>
                                ...
                                <ul role="list" className="mt-6 space-y-4">
                                    {navigation.solutions.map((item) => (
                                        <li key={item.name}>
                                            <a href={item.href} className="text-sm/6 opacity-60">
                                                {item.name}
                                            </a>
                                        </li>
                                    ))}
                ...
                <div className="mt-16 border-t border-background/10 pt-8 sm:mt-20 lg:mt-24">
                    <p className="text-sm/6 opacity-60">&copy; 2024 Flowly, Inc. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
