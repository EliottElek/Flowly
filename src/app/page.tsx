                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="mx-auto max-w-5xl text-center">
                                <h1 className="text-balance text-5xl font-semibold tracking-tight sm:text-6xl">
                                    <span className="text-emerald-400 font-bold">Flowly</span>, the open-source <span className="text-emerald-400">ticket management</span> platform you've been looking for.
                                </h1>
